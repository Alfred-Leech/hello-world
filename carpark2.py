...
data2=(r.json())
print ('what type is r.json')
print(type(r.json())) #the response is a dict
print()
print()
print('what r the keys in r.json ? there is only 1 key')
print(r.json().keys())
print()
print()
